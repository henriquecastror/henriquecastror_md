...
- **Dados reutilizados: Compartilhamento obrigatório**
    ...
    - Dados em repositórios públicos, como Dataverse, Mendeley, etc.
--
...
--
    ...
    - Se não tiverem direitos legais sobre os dados, **os autores deverão**:
        ...
        - Comprometer-se a **apoiar editores e revisores** que tentam replicar resultados.
...
- Materiais geram um doi que pode ser posteriormente **citado**. 
    ...
    - Exemplo: esse é o doi do último artigo publicado na RAC: [https://doi.org/10.7910/DVN/ZXBMHD](https://doi.org/10.7910/DVN/ZXBMHD) em **10 de Novembro**.
...
- **Após o artigo ser aceito**, revisores são convidados a permitirem que sua identificação apareça na versão final do artigo.

--

- Em paralelo, revisores e autores são convidados a permitirem a publitização de seus reports e suas cartas de resposta.
