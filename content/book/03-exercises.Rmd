...
**1) Using the dataset zCD1_CRIME2.dta, provide an estimation and a THOROUGH interpretation of the following model:**
...
**3)	Using the dataset zCD1_DiD.xlsx, provide an estimation and a THOROUGH interpretation of a difference-in-difference model:**
...
dataDiD  <- read_excel("zCD1_DiD.xlsx")
...
**Using the dataset zCD1_FERTIL2.rdata, provide an estimation and a THOROUGH interpretation of the following model by OLS:**
...
**5)	Using the dataset zCD1_RDD.xlsx, provide an estimation and a THOROUGH interpretation of regression discontinuity design.**
...
```{r}
rm(list = ls())
dataRDD  <- read_excel("zCD1_RDD.xlsx")
